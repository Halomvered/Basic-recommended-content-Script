...
var allKeyWords = hWords.concat(altWords,descriptionWords,keyWords);

//SORT KEYWORDS BY FREQUENCY OF APPEARENCE ON THE SITE
...
var wordsForContent = sortByFrequency(allKeyWords);
//USE wordsForContent[0] & wordsForContent[1] FOR RECOMMENDED CONTENT BOXES
...
'<a href="#"><li style="display: block;width: 24%;height: 100%; background-color: #333333; float: left;margin-left: .5%;position: relative;"><p style="text-decoration:none; color: #fff;text-transform: uppercase;text-align: center;top: 10%;font-size:80%;margin:10px 5px 0px 5px;">content related to this site\'s most common keyword:</br><strong>'+wordsForContent[0]+'</strong></p></li></a>\n'+

'<a href="#"><li style="display: block;width: 24%;height: 100%; background-color: #333333; float: left;margin-left: 1%;position: relative;"><p style="text-decoration:none; color: #fff;text-transform: uppercase;text-align: center;top: 10%;font-size:80%;margin:10px 5px 0px 5px;">content related to this site\'s most common keyword:</br><strong>'+wordsForContent[0]+'</strong></p></li></a>\n'+

'<a href="#"><li style="display: block;width: 24%;height: 100%; background-color: #333333; float: left;margin-left: 1%;position: relative;"><p style="text-decoration:none; color: #fff;text-transform: uppercase;text-align: center;top: 10%;font-size:80%;margin:10px 5px 0px 5px;">content related to this site\'s second most common keyword:</br><strong>'+wordsForContent[1]+'</strong></p></li></a>\n'+
...
//LOCATION OF INJECTION MUST BE CUSTOMIZED FOR EACH INDIVIDUAL SITE.
var footer = document.querySelector('footer');

//PREVENTION FOR ACTIVATING THE SCRIPT MORE THAN ONCE
document.querySelector('#hal-ad-box') ? '' : footer.parentNode.insertBefore(newDiv,footer);
